...
public class Constants {
    public static final String DATA_VIEWER_PAGE = "http://a.masteryodo.tmweb.ru/";

    public static final String CHROME_WEB_DRIVER_LOCAL_PATH = "src\\main\\resources\\chromedriver.exe";
    ...
    public static final String DOMAIN_PATH = "https://1xstavka.ru/ru/live/Volleyball/";
